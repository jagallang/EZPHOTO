# 📸 이지포토 (EZPHOTO) v1.1.02

Flutter로 개발된 크로스플랫폼 사진 레이아웃 편집 앱입니다. 다양한 그리드 레이아웃으로 사진을 배치하고, PDF 및 이미지로 내보낼 수 있습니다.
...
### 💾 내보내기 기능
- **이미지 저장**: 고해상도 PNG 파일로 갤러리 저장
- **PDF 내보내기**: 모든 페이지를 A4 크기 PDF로 생성
- **형식 선택**: 저장 시 이미지 또는 PDF 형식 선택 가능
